        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                   href="/" aria-label="Brand">GEGE STORE</a>
                <div class="md:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a class="font-medium {{request()->routeIs('home-page') ? 'text-blue-600' : 'text-gray-500'}}
                        py-3 md:py-6  dark:focus:outline-none
                        dark:focus:ring-1 dark:focus:ring-gray-600"
                           href="{{ route('home-page') }}" aria-current="page" wire:navigate>Home</a>

                        <a class="font-medium {{request()->routeIs('category-page') ? 'text-blue-600' : 'text-gray-500'}}
                        hover:text-gray-400 py-3 md:py-6  dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                           href="{{ route('category-page') }}"
                           wire:navigate>
                            Categories
                        </a>

                        <a class="font-medium {{request()->routeIs('products-page') ? 'text-blue-600' : 'text-gray-500'}}
                        hover:text-gray-400 py-3 md:py-6  dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                           href="{{ route('products-page') }}" wire:navigate>
                            Products
                        </a>

                        <a class="font-medium flex items-center {{request()->routeIs('cart-page') ? 'text-blue-600' :
                        'text-gray-500'}} hover:text-gray-400 py-3 md:py-6  dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                           href="{{ route('cart-page') }}" wire:navigate>
